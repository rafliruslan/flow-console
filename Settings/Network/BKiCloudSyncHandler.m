...
{
  // Load IDs from file
  if ((syncItems = [NSKeyedUnarchiver unarchiveObjectWithFile:[FlowConsolePaths blinkSyncItemsFile]]) == nil) {
...
+ (BOOL)saveSyncItems
{
  return [NSKeyedArchiver archiveRootObject:syncItems toFile:[FlowConsolePaths blinkSyncItemsFile]];
}
